...
This is a sample template for my-sam-app-nodejs - Below is a brief explanation of what we have generated for you:
...
```bash
sam logs -n HelloWorldFunction --stack-name my-sam-app-nodejs --tail
```
...
```bash
aws cloudformation delete-stack --stack-name my-sam-app-nodejs
```
